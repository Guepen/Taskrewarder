        ...
        <div class="row">
            <div class="col-md-12">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="{{ url('/') }}"><i class="mdi mdi-2x mdi-home"></i></a>

                </div>

                <div class="collapse navbar-collapse navbar-responsive-collapse" id="bs-example-navbar-collapse-1">
                    <form method="get" action="/users" class="navbar-form navbar-left">
                        <input type="text" class="form-control" placeholder="Sök efter användare">
                    </form>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        @else
                            ...
                            <li>
                                <a href="/tasks"><i class="mdi mdi-2x mdi-content-paste"></i> {{count(Auth::user()->getUserTasks)}}</a>
                            </li>
